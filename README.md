...
Задачи не только про код: прислать забытый дома файл, свести траты по выпискам, записать в дневник,
посмотреть, чем занят компьютер, — [docs/use-cases.md](docs/use-cases.md). Что бывает не так и как
это закрыть заранее — [docs/safety.md](docs/safety.md).
