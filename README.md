...
- агент может прислать в чат файл, но только из папки текущего проекта и только
  ...
  под это ограничение не попадают — держите их вне репозитория или в папке данных; тем более
  что содержимое архива шлюз не разбирает: упакованным уедет что угодно из папки проекта;
