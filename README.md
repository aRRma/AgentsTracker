...
Задачи не только про код: разобрать папку, свести выгрузки в отчёт, проверить домашние сервисы,
прислать файл из дома в чат — десять типовых сценариев в [docs/use-cases.md](docs/use-cases.md).
