    ...
    : IChatCommandHandler
{
    ...
    private string Prompt(UserId user)
    {
        ...
        // Как и у кнопки «Задать вопрос»: иначе следующий текст мог достаться ожиданию аргументов
    ...
    /// <summary>Приглашение написать вопрос — одно на команду и кнопки меню.</summary>
