    ...
    ILogger<OperatorConsole> logger) : IOperatorConsole
{
    ...
    /// по типу содержимого они не проверяются, единственным барьером остаются границы папки
    /// проекта и запрет ссылок наружу. Класть в проект секреты и просить их упаковать — нельзя.
    /// </summary>
