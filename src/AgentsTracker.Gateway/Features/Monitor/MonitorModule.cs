...
/// <summary>
/// Веб-монитор: страница состояния и статистики на своём порту, без авторизации, только
/// 127.0.0.1. Ничего не меняет: у страницы нет ни токена, ни пользователя, поэтому все
/// действия остаются в чате.
/// </summary>
