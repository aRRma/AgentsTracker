...
/// <summary>
/// Что бэкенд сообщает по ходу запуска. Оба метода зовутся из потока чтения вывода агента:
/// обработчики должны быть быстрыми и не бросать, иначе застопорят разбор вывода.
/// </summary>
