...
`ClaudeLimits.LooksLikePercents`: значение больше 1 или все значения целые — проценты, иначе доли.
По одному окну шкалу не угадать: `utilization: 1` — это и «1% после сброса», и «выбрано
полностью». Пока решение принималось по каждому окну, 10.09.2026 бот час отказывал на **пустом**
пятичасовом окне, показывая сброс нового окна как время ожидания.
